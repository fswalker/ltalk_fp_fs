...
let gitOwner = "fswalker"
let gitHome = "https://github.com/" + gitOwner
// The name of the project on GitHub
let gitProjectName = "ltalk_fp_fs"
...
let startWebServer () =
    ...
    let mimeTypes =
        defaultMimeTypesMap @@ (function | ".webm" -> mkMimeType "video/webm" false | _ -> None)
...
Target "Replace Template" <| fun _ ->
    let target = __SOURCE_DIRECTORY__ </> "packages/FsReveal/fsreveal/template.html"
    let source = slidesDir </> "template.html"
